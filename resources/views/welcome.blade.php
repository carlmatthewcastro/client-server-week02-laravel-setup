        ...
        <section class="hero">
            <div class="profile-panel">
                ...
                <div class="details-card" id="details">
                    ...
                    <x-detail-row label="Current Date" :value="$student['date']" />
                </div>
            </div>
            ...
            <div class="profile-image-panel">
                ...
                <div class="social-links" id="contact">
                    <x-social-link href="#" title="LinkedIn" aria-label="LinkedIn">
                    ...
                    <x-social-link href="#" title="GitHub" aria-label="GitHub">
                    ...
                    <x-social-link href="#" title="Twitter" aria-label="Twitter">
                    ...
                    <x-social-link href="#" title="Email" aria-label="Email">
